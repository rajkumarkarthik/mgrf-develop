...
#ifndef MGRF_UTILITY_H_
#define MGRF_UTILITY_H_
...
inline void write_matrix(const Eigen::MatrixXd& matrix, std::ostream& file) {
...
inline Eigen::MatrixXd read_matrix(std::istream& file) {
