...
#ifndef MGRF_REGULARIZEDREGRESSIONSPLITTINGRULEFACTORY_H
#define MGRF_REGULARIZEDREGRESSIONSPLITTINGRULEFACTORY_H
...
#endif //MGRF_REGULARIZEDREGRESSIONSPLITTINGRULEFACTORY_H
