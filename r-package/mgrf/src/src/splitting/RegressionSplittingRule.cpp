...
void RegressionSplittingRule::find_best_split_value_small_q(size_t node, size_t var, Eigen::VectorXd sum_node,
...
void RegressionSplittingRule::find_best_split_value_large_q(size_t node, size_t var, Eigen::VectorXd sum_node,
                                                            size_t num_samples_node,
                                                            size_t min_child_samples,
                                                            double& best_value,
                                                            size_t& best_var,
